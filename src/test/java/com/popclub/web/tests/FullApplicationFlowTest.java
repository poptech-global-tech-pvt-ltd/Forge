...
public class FullApplicationFlowTest extends WebBaseTest {
    ...
    private static final String PAN_NUMBER     = "BDFPD4509D";
    ...
    private static final String MAP_QUERY      = "POPCLU";
    private static final String MAP_SUGGESTION = "POP Club, Madkam centre,";
    ...
    public void fullEligibilityApplicationFlow() {
        ...
        personalPage.fillFirstName(FIRST_NAME)
                    ...
                    .selectDateOfBirth(DOB_YEAR, DOB_OPTION)
                    .fillEmail(EMAIL)
                    .selectSalaried()
                    .selectMarried()
                    .selectFemale()
