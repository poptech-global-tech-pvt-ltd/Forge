...
public final class TestDataLoader {
    ...
    public static TestUser loadValidUser() {
        try (InputStream is = TestDataLoader.class.getClassLoader()
            ...
            if (is == null) {
                throw new RuntimeException("valid_user_details_card_onboarding.json not found in apiTests/card/");
            }
    ...
    public static InvalidCases loadInvalidCases() {
        try (InputStream is = TestDataLoader.class.getClassLoader()
            ...
            if (is == null) {
                throw new RuntimeException("invalid_cases_card_onboarding.json not found in apiTests/card/");
            }
