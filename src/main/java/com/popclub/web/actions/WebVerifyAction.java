...
public class WebVerifyAction implements Action {

    private static final Logger log = LoggerFactory.getLogger(WebVerifyAction.class);
    ...
    public void perform(Step step) {
        ...
        if (!el.isVisible()) throw new RuntimeException("[WEB] Element not visible: " + selector);
        log.info("[WEB] Verified visible: {}", selector);
    }
